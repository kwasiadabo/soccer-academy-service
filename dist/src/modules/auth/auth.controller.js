...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Access token issued; refresh token set as an httpOnly cookie.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'New access token issued; refresh token cookie rotated.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing, invalid, or expired refresh token.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Generic confirmation, regardless of whether the email exists.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Password reset.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Password changed.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing/invalid access token, or wrong current password.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Logged out.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid access token.' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
