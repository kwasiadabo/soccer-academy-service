...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List opponent clubs.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Opponents returned.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create an opponent club.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Opponent created.' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.MATCHES_MANAGE),
    (0, swagger_1.ApiOperation)({ summary: 'List matches.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Match returned.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Schedule a match.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Match created.' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Match updated.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Set the squad/participations for a match.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Participations set.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add a player assessment for a match.' }),
