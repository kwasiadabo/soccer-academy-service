...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List fee items.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Fee items returned.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a fee item.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Fee item created.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update a fee item.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Fee item updated.' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'List fee types.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Fee types returned.' }),
    __param(0, (0, common_1.Query)('includeInactive')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a fee type.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Fee type created.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update a fee type.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Fee type updated.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add a fee item to a fee type.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Fee item added.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Remove a fee item from a fee type.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Fee item removed.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'Get per-team financial stats.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Stats returned.' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'List players with outstanding balances.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Debtors returned.' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'List debtors aged past a minimum number of months.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Aged debtors returned.' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'Get a payments report, optionally filtered by date range, fee type, or player.' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'Get the monthly billing summary.' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)(permissions_constants_1.PERMISSIONS.FINANCE_VIEW),
    (0, swagger_1.ApiOperation)({ summary: "List a player's invoices." }),
    (0, swagger_1.ApiOkResponse)({ description: 'Invoices returned.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ description: 'Invoice created.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ description: 'Payment recorded.' }),
    __param(0, (0, common_1.Body)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Generate recurring invoices that are due.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Recurring invoices generated.' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Send a payment reminder for an invoice.' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Reminder sent.' }),
    __param(0, (0, common_1.Param)('id')),
