...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Submit a public enrollment inquiry (unauthenticated).' }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Inquiry created.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List public enrollment inquiries.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Inquiries returned.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update the status of an inquiry.' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Inquiry updated.' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Missing or invalid access token.' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Caller lacks the required permission.' }),
